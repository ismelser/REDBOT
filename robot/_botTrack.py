        ...
        for i in range(1,20):
          ...
          try:
            if center==None: 
              point=100
              exit()
            if center[0]>=800: point=11
            if center[0]>550 and center[0]<800: point=10
            if center[0]<=200: point=21
            if center[0]<450 and center[0]>200: point=20
            if center[0]<=550 and center[0]>=450: point=1
            print(center)
          except:
            pass
          print("Count="+str(point))
